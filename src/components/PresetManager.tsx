...
import { Save, Trash2, Download, Upload, Plus, Check, X, Settings2, ChevronDown, ChevronRight } from 'lucide-react';
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        {!isCollapsed && (
          <button
            ...
            className="ml-auto flex items-center gap-2 px-3 py-1 text-xs font-mono text-red-500/70 hover:text-red-500 transition-colors"
          >
